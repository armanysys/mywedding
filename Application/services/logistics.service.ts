...
/**
 * Application Layer - Logistics Service
 * 
 * Centralized service for all logistics-related API calls.
 * This service handles business logic and data processing for event logistics.
 */

const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || ""

/**
 * Fetches logistics section data from the API (Server-side)
