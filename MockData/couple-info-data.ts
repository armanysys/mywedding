...
export const coupleInfo: Couple = {
  ...
  GroomFamily: {
    ...
    FamilyHistory:
      'The Antonio family has a rich history of community involvement and entrepreneurship, with roots tracing back to early settlers in the region.',
  },
  BrideFamily: {
    FaherName: 'Miguel Lopez',
    MotherName: 'Ana Martinez',
    FamilyHistory:
      'The Lopez family is known for their strong traditions and deep commitment to family values, having raised several generations of successful individuals.',
  },
};
