...
/**
 * Application Layer - Couple Info Service
 * 
 * Centralized service for all couple-info-related API calls.
 * This service handles business logic and data processing for couple information.
 */

const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || ""

/**
 * Fetches couple information from the API (Server-side)
